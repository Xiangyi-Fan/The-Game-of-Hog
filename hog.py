...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            score0 += take_turn(s0(score0,score1),score1,dice)
            if is_swap(score0,score1):
                score0,score1 = score1,score0
        else:
            score1 += take_turn(s1(score1,score0),score0,dice)
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def cal(score0,score1):
        ...
        if score0 - ps > ph:
            if score0 - ps == 1 :
                print(score0 - ps,"point! That's the biggest gain yet for Player",who)
            else:
                print(score0 - ps,"points! That's the biggest gain yet for Player",who)
            ph = score0 - ps
        ps = score0
        """elif who == 1:
            if score1 - ps > ph:
                if score1 - ps == 1 :
                    print(abs(score1 - ps),"point! That's the biggest gain yet for Player 1")
                else:
                    print(abs(score1 - ps),"points! That's the biggest gain yet for Player 1")
                ph = score1 - ps
            ps = score1"""
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    while i <= 10:    
        if averaged_dice < a(i,dice):
            averaged_dice = a(i,dice)
            n = i
        i += 1
    return n
    "*** YOUR CODE HERE ***"
...
'''def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(score, opponent_score):
        if score < opponent_score or free_bacon(opponent_score) >= margin:
            return 0
        else:
            return num_rolls
